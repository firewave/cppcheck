...
#define ITERATOR_BEGIN_FUNC_PATTERN "begin|cbegin|rbegin|crbegin"
#define ITERATOR_END_FUNC_PATTERN "end|cend|rend|crend"

#define PATTERN1X1_1 "%name% . " ITERATOR_BEGIN_FUNC_PATTERN " ( ) , "
#define PATTERN1X1_2 "%name% . ITERATOR_END_FUNC_PATTERN ( ) ,|)"
#define PATTERN2 PATTERN1X1_1 PATTERN1X1_2
...
void CheckStl::mismatchingContainers()
{
    ...
    for (const Variable *var : symbolDatabase->variableList()) {
        if (var && var->isStlStringType() && Token::Match(var->nameToken(), "%var% (") && Token::Match(var->nameToken()->tokAt(2), PATTERN2)) {
