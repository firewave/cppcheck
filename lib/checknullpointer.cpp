 ...
 */
void CheckNullPointerImpl::parseFunctionCall(const Token &tok, std::list<const Token *> &var, const Library &library, bool checkNullArg)
{
...
{
    return false; //isPointerDeRef(tok, unknown, *mSettings);
}
