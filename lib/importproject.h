...
public:
    ...
    Type import(const std::string &filename, Settings *settings=nullptr, SuppressionList* suppressions=nullptr);
protected:
    bool importCompileCommands(std::istream &istr);
    bool importCppcheckGuiProject(std::istream &istr, Settings *settings, SuppressionList* suppressions);
