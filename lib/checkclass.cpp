...
namespace {
    ...
    public:
        ...
        void checkConstError(const Token *tok, const std::string &classname, const std::string &funcname, bool suggestStatic, bool foundAllBaseClasses);
        void checkConstError2(const Token *tok1, const Token *tok2, const std::string &classname, const std::string &funcname, bool suggestStatic, bool foundAllBaseClasses);
...
void CheckClass::getErrorMessages(ErrorLogger *errorLogger, const Settings *settings) const
{
    ...
    c.checkConstError(nullptr, "class", "function", false, true);
    c.checkConstError(nullptr, "class", "function", true, false);
    c.initializerListError(nullptr, nullptr, "class", "variable", "arg");
