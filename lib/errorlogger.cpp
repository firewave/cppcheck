...
bool ErrorMessage::deserialize(const std::string &data)
{
    ...
    while (iss.good()) {
        ...
        ErrorMessage::FileLocation loc(substrings[3], static_cast<int>(MathLib::toLongNumber(substrings[0])), static_cast<unsigned int>(MathLib::toLongNumber(substrings[1])));
