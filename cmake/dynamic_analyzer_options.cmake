...
elseif(ANALYZE_ADDRESS)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        ...
        #add_compile_options(-mllvm -asan-use-after-scope)
        #add_compile_options(-mllvm -asan-detect-invalid-pointer-pair)
        #add_compile_options(-mllvm -asan-detect-invalid-pointer-cmp)
        #add_compile_options(-mllvm -asan-detect-invalid-pointer-sub)
    endif()
