...
LIBOBJ =      $(libcppdir)/valueflow.o \
              ...
              $(libcppdir)/vf_dynamicbuffersize.o \
...
$(libcppdir)/vf_dynamicbuffersize.o: lib/vf_dynamicbuffersize.cpp lib/addoninfo.h lib/analyzer.h lib/astutils.h lib/config.h lib/errortypes.h lib/library.h lib/mathlib.h lib/platform.h lib/settings.h lib/smallvector.h lib/sourcelocation.h lib/standards.h lib/suppressions.h lib/symboldatabase.h lib/templatesimplifier.h lib/token.h lib/utils.h lib/vf_dynamicbuffersize.h lib/vf_forward.h lib/vfvalue.h
	$(CXX) ${INCLUDE_FOR_LIB} $(CPPFLAGS) $(CXXFLAGS) -c -o $@ $(libcppdir)/vf_dynamicbuffersize.cpp
