...
private:
    ...
    void getAnalyzerInfoFile() const {
        ...
        ASSERT_EQUALS("builddir/file1.c.analyzerinfo", AnalyzerInformationTest::getAnalyzerInfoFile("builddir", "file1.c", "", 0));
        ASSERT_EQUALS("builddir/file1.c.analyzerinfo", AnalyzerInformationTest::getAnalyzerInfoFile("builddir", "some/path/file1.c", "", 0));
    }
    ...
    void parse() const {
        AnalyzerInformationTest::Info info;
