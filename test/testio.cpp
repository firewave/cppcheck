...
#define check(...) check_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void useClosedFile() {
        ...
        ASSERT_EQUALS("[test.cpp:3:5]: (error) Used file that is not opened. [useClosedFile]\n"
                      ...
                      "[test.cpp:3:5]: (error) Used file that is not opened. [useClosedFile]\n", errout_str());
    ...
    void testScanf1() {
        ...
        ASSERT_EQUALS("[test.cpp:4]: (warning) fscanf() without field width limits can crash with huge input data.\n"
                      ...
                      "[test.cpp:4:9]: (warning) fscanf() without field width limits can crash with huge input data. [invalidscanf]\n", errout_str());
    }
    ...
    void testScanf5() { // #10632
        ...
        ASSERT_EQUALS("[test.cpp:3]: (error) Width 42 given in format string (no. 1) is larger than destination buffer 's1[42]', use %41s to prevent overflowing it.\n"
                      "[test.cpp:3:5]: (error) Width 42 given in format string (no. 1) is larger than destination buffer 's1[42]', use %41s to prevent overflowing it. [invalidScanfFormatWidth]\n", errout_str());
    }
...
#define TEST_PRINTF_WARN_AKA_CPP_WIN32(FORMAT, FORMATSTR, TYPE, AKATYPE_WIN32) \
    ...
    void testScanfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) scanf format string requires 0 parameters but 1 is given.\n"
                      ...
                      "[test.cpp:2:5]: (warning) scanf format string requires 0 parameters but 1 is given. [wrongPrintfScanfArgNum]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (error) scanf format string requires 1 parameter but only 0 are given.\n"
                      ...
                      "[test.cpp:2:5]: (error) scanf format string requires 1 parameter but only 0 are given. [wrongPrintfScanfArgNum]\n", errout_str());
        ...
        check("void foo() {\n"
              ...
              "}");
        ASSERT_EQUALS("[test.cpp:6:5]: (error) Width 5 given in format string (no. 1) is larger than destination buffer 'output[5]', use %4s to prevent overflowing it. [invalidScanfFormatWidth]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:5]: (warning, inconclusive) Width 3 given in format string (no. 1) is smaller than destination buffer 'output[5]'.\n"
                      ...
                      "[test.cpp:5:5]: (warning, inconclusive) Width 3 given in format string (no. 1) is smaller than destination buffer 'output[5]'. [invalidScanfFormatWidth_smaller]\n", errout_str());
        ...
        check("void foo() {\n"
              ...
              "    sscanf(input, \"%5s\", output);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:6:22]: (warning, inconclusive) Width 36 given in format string (no. 1) is smaller than destination buffer 'projectId[2048]'. [invalidScanfFormatWidth_smaller]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) 'h' in format string (no. 1) is a length modifier and cannot be used without a conversion specifier.\n"
                      ...
                      "[test.cpp:2:3]: (warning) 'h' in format string (no. 1) is a length modifier and cannot be used without a conversion specifier. [invalidLengthModifierError]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %u in format string (no. 1) requires 'unsigned int *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %u in format string (no. 1) requires 'unsigned int *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());

        check("void foo(long l) {\n"
              "    scanf(\"%u\", l);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %u in format string (no. 1) requires 'unsigned int *' but the argument type is 'signed long'. [invalidScanfArgType_int]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %Ld in format string (no. 1) requires 'long long *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %Ld in format string (no. 1) requires 'long long *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());

        check("void foo(int i) {\n"
              "    scanf(\"%Ld\", i);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %Ld in format string (no. 1) requires 'long long *' but the argument type is 'signed int'. [invalidScanfArgType_int]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 1) requires 'int *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %d in format string (no. 1) requires 'int *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());

        check("void foo(long l) {\n"
              "    scanf(\"%d\", l);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %d in format string (no. 1) requires 'int *' but the argument type is 'signed long'. [invalidScanfArgType_int]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %x in format string (no. 1) requires 'unsigned int *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %x in format string (no. 1) requires 'unsigned int *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());

        check("void foo(long l) {\n"
              "    scanf(\"%x\", l);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %x in format string (no. 1) requires 'unsigned int *' but the argument type is 'signed long'. [invalidScanfArgType_int]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %f in format string (no. 1) requires 'float *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %f in format string (no. 1) requires 'float *' but the argument type is 'const char *'. [invalidScanfArgType_float]\n", errout_str());

        check("void foo(float f) {\n"
              "    scanf(\"%f\", f);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %f in format string (no. 1) requires 'float *' but the argument type is 'float'. [invalidScanfArgType_float]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'const char *'.\n"
                      "[test.cpp:2:5]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());

        check("void foo(long l) {\n"
              "    scanf(\"%n\", l);\n"
              "}", dinit(CheckOptions, $.inconclusive = true));
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'signed long'. [invalidScanfArgType_int]\n", errout_str());
...

        {
            ...
            const char* result("[test.cpp:5]: (portability) %zd in format string (no. 1) requires 'ssize_t *' but the argument type is 'size_t * {aka unsigned long *}'.\n"
                               "[test.cpp:5:5]: (portability) %zd in format string (no. 1) requires 'ssize_t *' but the argument type is 'size_t * {aka unsigned long *}'. [invalidScanfArgType_int]\n");
            const char* result_win64("[test.cpp:5]: (portability) %zd in format string (no. 1) requires 'ssize_t *' but the argument type is 'size_t * {aka unsigned long long *}'.\n"
                                     "[test.cpp:5:5]: (portability) %zd in format string (no. 1) requires 'ssize_t *' but the argument type is 'size_t * {aka unsigned long long *}'. [invalidScanfArgType_int]\n");
        ...
        }
        {
            ...
            ASSERT_EQUALS("[test.cpp:3]: (warning) %s in format string (no. 1) requires a 'char *' but the argument type is 'const char *'.\n"
                          "[test.cpp:3:5]: (warning) %s in format string (no. 1) requires a 'char *' but the argument type is 'const char *'. [invalidScanfArgType_s]\n", errout_str());
        }

        check("void f() {\n" // #7038
              "    scanf(\"%i\", \"abc\" + 1);\n"
              "}\n");
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %i in format string (no. 1) requires 'int *' but the argument type is 'const char *'. [invalidScanfArgType_int]\n", errout_str());
    }
    ...
    void testPrintfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (error) printf format string requires 1 parameter but only 0 are given.\n"
                      ...
                      "[test.cpp:2:5]: (error) printf format string requires 1 parameter but only 0 are given. [wrongPrintfScanfArgNum]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) printf format string requires 0 parameters but 1 is given.\n"
                      ...
                      "[test.cpp:2:5]: (warning) printf format string requires 0 parameters but 1 is given. [wrongPrintfScanfArgNum]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) swprintf format string requires 1 parameter but 2 are given.\n"
                      "[test.cpp:2:5]: (warning) swprintf format string requires 1 parameter but 2 are given. [wrongPrintfScanfArgNum]\n", errout_str());
        ...
        check("void foo(char* s, const char* s2, std::string s3, int i) {\n"
              ...
              "    printf(\"%u\", s);\n"
              "}");
        ASSERT_EQUALS("[test.cpp:3:5]: (warning) %s in format string (no. 1) requires 'char *' but the argument type is 'signed int'. [invalidPrintfArgType_s]\n"
                      "[test.cpp:4:5]: (warning) %s in format string (no. 1) requires 'char *' but the argument type is 'std::string'. [invalidPrintfArgType_s]\n"
                      "[test.cpp:5]: (warning) %s in format string (no. 1) requires 'char *' but the argument type is 'std::string'.\n"
                      "[test.cpp:3:5]: (warning) %s in format string (no. 1) requires 'char *' but the argument type is 'signed int'. [invalidPrintfArgType_s]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %jd in format string (no. 1) requires 'intmax_t' but the argument type is 'char *'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %jd in format string (no. 1) requires 'intmax_t' but the argument type is 'char *'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %ju in format string (no. 1) requires 'uintmax_t' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %ju in format string (no. 1) requires 'uintmax_t' but the argument type is 'unsigned int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'signed int'. [invalidPrintfArgType_n]\n", errout_str());

        check("void foo() {\n"
              "    printf(\"%n\", L\"s5W\");\n"
              "}");
        ASSERT_EQUALS("[test.cpp:2:5]: (warning) %n in format string (no. 1) requires 'int *' but the argument type is 'const wchar_t *'. [invalidPrintfArgType_n]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %X in format string (no. 1) requires 'unsigned int' but the argument type is 'foo'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %X in format string (no. 1) requires 'unsigned int' but the argument type is 'foo'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %x in format string (no. 1) requires 'unsigned int' but the argument type is 'const char *'.\n"
                      "[test.cpp:3:5]: (warning) %x in format string (no. 1) requires 'unsigned int' but the argument type is 'const char *'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %x in format string (no. 1) requires 'unsigned int' but the argument type is 'const wchar_t *'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %x in format string (no. 1) requires 'unsigned int' but the argument type is 'const wchar_t *'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %i in format string (no. 1) requires 'int' but the argument type is 'foo'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %i in format string (no. 1) requires 'int' but the argument type is 'foo'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %i in format string (no. 1) requires 'int' but the argument type is 'const wchar_t *'.\n"
                      "[test.cpp:3:5]: (warning) %i in format string (no. 1) requires 'int' but the argument type is 'const wchar_t *'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'foo'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'foo'. [invalidPrintfArgType_uint]\n", errout_str());

        check("class foo {};\n"
              "void foo(const int* cpi, foo f, bar b, bar* bp, double d, int i, bool bo) {\n"
              "    printf(\"%u\", L\"s5W\");\n"
              "}");
        ASSERT_EQUALS("[test.cpp:3:5]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'const wchar_t *'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %p in format string (no. 1) requires an address but the argument type is 'foo'.\n"
                      "[test.cpp:3:5]: (warning) %p in format string (no. 1) requires an address but the argument type is 'foo'. [invalidPrintfArgType_p]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'foo'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'foo'. [invalidPrintfArgType_float]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'const char *'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'const char *'. [invalidPrintfArgType_float]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'const wchar_t *'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %e in format string (no. 1) requires 'double' but the argument type is 'const wchar_t *'. [invalidPrintfArgType_float]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hhx in format string (no. 1) requires 'unsigned char' but the argument type is 'signed char'.\n"
                      "[test.cpp:2:3]: (warning) %hhx in format string (no. 1) requires 'unsigned char' but the argument type is 'signed char'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        check("void foo(long long l, ptrdiff_t p, std::ptrdiff_t sp) {\n"
              ...
              "  printf(\"%td\", l);\n"
              "}");
        ASSERT_EQUALS("[test.cpp:4:3]: (warning) %td in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'signed long long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %zx in format string (no. 1) requires 'size_t' but the argument type is 'signed int'.\n"
                      "[test.cpp:2:3]: (warning) %zx in format string (no. 1) requires 'size_t' but the argument type is 'signed int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %zu in format string (no. 1) requires 'size_t' but the argument type is 'unsigned int'.\n"
                      "[test.cpp:2:3]: (warning) %zu in format string (no. 1) requires 'size_t' but the argument type is 'unsigned int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %tx in format string (no. 1) requires 'unsigned ptrdiff_t' but the argument type is 'signed int'.\n"
                      "[test.cpp:2:3]: (warning) %tx in format string (no. 1) requires 'unsigned ptrdiff_t' but the argument type is 'signed int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hd in format string (no. 1) requires 'short' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:2:3]: (warning) %hd in format string (no. 1) requires 'short' but the argument type is 'unsigned int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'size_t {aka unsigned long}'.\n"
                      "[test.cpp:2:3]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'size_t {aka unsigned long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'std::size_t {aka unsigned long}'.\n"
                      "[test.cpp:2:3]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'std::size_t {aka unsigned long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'size_t {aka unsigned long long}'.\n"
                      "[test.cpp:2:3]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'size_t {aka unsigned long long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'std::size_t {aka unsigned long long}'.\n"
                      "[test.cpp:2:3]: (portability) %zd in format string (no. 1) requires 'ssize_t' but the argument type is 'std::size_t {aka unsigned long long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        check("void foo(size_t s, uintmax_t um) {\n"
              ...
              "  printf(\"%llu\", um);\n"
              "}", dinit(CheckOptions, $.portability = true, $.platform = Platform::Type::Win64));
        ASSERT_EQUALS("[test.cpp:2:5]: (portability) %lu in format string (no. 1) requires 'unsigned long' but the argument type is 'size_t {aka unsigned long long}'. [invalidPrintfArgType_uint]\n"
                      ...
                      "[test.cpp:2:3]: (portability) %lu in format string (no. 1) requires 'unsigned long' but the argument type is 'size_t {aka unsigned long long}'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %ld in format string (no. 1) requires 'long' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:2:3]: (warning) %ld in format string (no. 1) requires 'long' but the argument type is 'unsigned int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        check("void foo(int i, intmax_t im, ptrdiff_t p) {\n"
              ...
              "  printf(\"%lld\", p);\n"
              "}");
        ASSERT_EQUALS("[test.cpp:2:3]: (warning) %lld in format string (no. 1) requires 'long long' but the argument type is 'signed int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %lld in format string (no. 1) requires 'long long' but the argument type is 'intmax_t {aka signed long long}'.\n"
                      "[test.cpp:2:3]: (portability) %lld in format string (no. 1) requires 'long long' but the argument type is 'intmax_t {aka signed long long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:13]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'double'.\n"
                      ...
                      "[test.cpp:13:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'double'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed short'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed short'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %ld in format string (no. 3) requires 'long' but the argument type is 'unsigned short'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %ld in format string (no. 3) requires 'long' but the argument type is 'unsigned short'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed long'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed long long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed long long'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned long long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'unsigned long long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'float'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'float'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'double'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'double'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'long double'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'long double'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %I64d in format string (no. 1) requires '__int64' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %I64d in format string (no. 1) requires '__int64' but the argument type is 'signed int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %I32d in format string (no. 1) requires '__int32' but the argument type is 'signed long long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %I32d in format string (no. 1) requires '__int32' but the argument type is 'signed long long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %I32d in format string (no. 1) requires '__int32' but the argument type is 'unsigned long long'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %I32d in format string (no. 1) requires '__int32' but the argument type is 'unsigned long long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'signed char'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'signed char'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'unsigned char'.\n"
                      ...
                      "[test.cpp:2:14]: (warning) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'unsigned char'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:3:14]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %ld in format string (no. 2) requires 'long' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:3:14]: (warning) %ld in format string (no. 2) requires 'long' but the argument type is 'signed int'. [invalidPrintfArgType_sint]\n",
                      errout_str());
        ...
        check("int array[10];\n"
              ...
              "    printf(\"%f\", foo()[0]);\n"
              "}");
        ASSERT_EQUALS("[test.cpp:4:5]: (warning) %f in format string (no. 1) requires 'double' but the argument type is 'signed int'. [invalidPrintfArgType_float]\n", errout_str());
        ...
        check("std::vector<int> v;\n"
              ...
              "}");
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'.\n"
                      "[test.cpp:3:5]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'signed int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (portability) %d in format string (no. 3) requires 'int' but the argument type is 'std::size_t {aka unsigned long}'.\n"
                      ...
                      "[test.cpp:4:5]: (portability) %d in format string (no. 3) requires 'int' but the argument type is 'std::size_t {aka unsigned long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (portability) %d in format string (no. 3) requires 'int' but the argument type is 'std::size_t {aka unsigned long long}'.\n"
                      ...
                      "[test.cpp:4:5]: (portability) %d in format string (no. 3) requires 'int' but the argument type is 'std::size_t {aka unsigned long long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'int'.\n"
                      "[test.cpp:3:5]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 3) requires 'unsigned int' but the argument type is 'const char *'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %u in format string (no. 3) requires 'unsigned int' but the argument type is 'const char *'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:8]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'char *'.\n"
                      ...
                      "[test.cpp:8:5]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'char *'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:13]: (portability) %zd in format string (no. 2) requires 'ssize_t' but the argument type is 'ptrdiff_t {aka signed long}'.\n"
                      ...
                      "[test.cpp:13:5]: (portability) %zd in format string (no. 2) requires 'ssize_t' but the argument type is 'ptrdiff_t {aka signed long}'. [invalidPrintfArgType_sint]\n"
        ...
        ASSERT_EQUALS("[test.cpp:13]: (warning) %ld in format string (no. 1) requires 'long' but the argument type is 'bool'.\n"
                      ...
                      "[test.cpp:13:5]: (warning) %ld in format string (no. 1) requires 'long' but the argument type is 'bool'. [invalidPrintfArgType_sint]\n"
        ...
        ASSERT_EQUALS("[test.cpp:6]: (portability) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'size_t {aka unsigned long}'.\n"
                      ...
                      "[test.cpp:6:5]: (portability) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'size_t {aka unsigned long}'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:5]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'const char *'.\n"
                      ...
                      "[test.cpp:5:5]: (warning) %d in format string (no. 2) requires 'int' but the argument type is 'const char *'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        check("template <class T>\n"
              ...
              "    printf(\"%u\", b.size());\n"
              "}\n", dinit(CheckOptions, $.portability = true, $.platform = Platform::Type::Unix64));
        ASSERT_EQUALS("[test.cpp:7:5]: (portability) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'size_t {aka unsigned long}'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (portability) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'DWORD {aka unsigned long}'.\n"
                      "[test.cpp:4:5]: (portability) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'DWORD {aka unsigned long}'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned long'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %f in format string (no. 1) requires 'double' but the argument type is 'signed int'.\n"
                      "[test.cpp:2:5]: (warning) %f in format string (no. 1) requires 'double' but the argument type is 'signed int'. [invalidPrintfArgType_float]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'signed long'.\n"
                      ...
                      "[test.cpp:3:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'signed long'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'char'.\n"
                      "[test.cpp:3:4]: (warning) %u in format string (no. 2) requires 'unsigned int' but the argument type is 'char'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:9]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'int'.\n"
                      "[test.cpp:9:5]: (warning) %u in format string (no. 1) requires 'unsigned int' but the argument type is 'int'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %Ld in format string (no. 1) requires 'long long' but the argument type is 'signed int'.\n"
                      "[test.cpp:2:5]: (warning) %Ld in format string (no. 1) requires 'long long' but the argument type is 'signed int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        check("void foo(char c, unsigned char uc, short s, unsigned short us, int i, unsigned int ui, long l, unsigned long ul) {\n"
              ...
              "}");
        ASSERT_EQUALS("[test.cpp:2:3]: (warning) %hhx in format string (no. 1) requires 'unsigned char' but the argument type is 'signed char'. [invalidPrintfArgType_uint]\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hhd in format string (no. 2) requires 'char' but the argument type is 'unsigned char'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hhu in format string (no. 1) requires 'unsigned char' but the argument type is 'char'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hhu in format string (no. 1) requires 'unsigned char' but the argument type is 'char'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hhx in format string (no. 1) requires 'unsigned char' but the argument type is 'char'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hhx in format string (no. 1) requires 'unsigned char' but the argument type is 'char'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hd in format string (no. 1) requires 'short' but the argument type is 'char'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hd in format string (no. 1) requires 'short' but the argument type is 'char'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hu in format string (no. 1) requires 'unsigned short' but the argument type is 'char'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hu in format string (no. 1) requires 'unsigned short' but the argument type is 'char'. [invalidPrintfArgType_uint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (warning) %hx in format string (no. 1) requires 'unsigned short' but the argument type is 'char'.\n"
                      ...
                      "[test.cpp:2:5]: (warning) %hx in format string (no. 1) requires 'unsigned short' but the argument type is 'char'. [invalidPrintfArgType_uint]\n", errout_str());
    ...
    void testPosixPrintfScanfParameterPosition() { // #4900  - No support for parameters in format strings
        ...
        ASSERT_EQUALS("[test.cpp:3]: (error) printf format string requires 1 parameter but only 0 are given.\n"
                      ...
                      "[test.cpp:3:3]: (error) printf format string requires 1 parameter but only 0 are given. [wrongPrintfScanfArgNum]\n"
                      "", errout_str());
    }
    ...
    void testMicrosoftPrintfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:8]: (portability) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'size_t {aka unsigned long}'.\n"
                      ...
                      "[test.cpp:8:5]: (portability) %Id in format string (no. 1) requires 'ptrdiff_t' but the argument type is 'size_t {aka unsigned long}'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (warning) 'I' in format string (no. 1) is a length modifier and cannot be used without a conversion specifier.\n"
                      ...
                      "[test.cpp:4:5]: (warning) 'I' in format string (no. 1) is a length modifier and cannot be used without a conversion specifier. [invalidLengthModifierError]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (portability) %d in format string (no. 1) requires 'int' but the argument type is 'UINT32 {aka unsigned int}'.\n"
                      "[test.cpp:2:5]: (portability) %d in format string (no. 1) requires 'int' but the argument type is 'UINT32 {aka unsigned int}'. [invalidPrintfArgType_sint]\n", errout_str());
    ...
    void testMicrosoftScanfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:8]: (portability) %Id in format string (no. 1) requires 'ptrdiff_t *' but the argument type is 'size_t * {aka unsigned long *}'.\n"
                      ...
                      "[test.cpp:8:5]: (portability) %Id in format string (no. 1) requires 'ptrdiff_t *' but the argument type is 'size_t * {aka unsigned long *}'. [invalidScanfArgType_int]\n", errout_str());
    ...
    void testMicrosoftCStringFormatArguments() { // ticket #4920
        ...
        ASSERT_EQUALS("[test.cpp:4]: (portability) %I32d in format string (no. 1) requires '__int32' but the argument type is 'unsigned __int32 {aka unsigned int}'.\n"
                      ...
                      "[test.cpp:4:12]: (portability) %I32d in format string (no. 1) requires '__int32' but the argument type is 'unsigned __int32 {aka unsigned int}'. [invalidPrintfArgType_sint]\n", errout_str());
    }
    ...
    void testMicrosoftSecurePrintfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:4]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:4:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned int'.\n"
                      ...
                      "[test.cpp:5:5]: (warning) %d in format string (no. 1) requires 'int' but the argument type is 'unsigned int'. [invalidPrintfArgType_sint]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:6]: (warning) %s in format string (no. 5) requires 'char *' but the argument type is 'signed int'.\n"
                      ...
                      "[test.cpp:6:5]: (warning) %s in format string (no. 5) requires 'char *' but the argument type is 'signed int'. [invalidPrintfArgType_s]\n", errout_str());
    ...
    void testMicrosoftSecureScanfArgument() {
        ...
        ASSERT_EQUALS("[test.cpp:5]: (warning) %d in format string (no. 2) requires 'int *' but the argument type is 'unsigned int *'.\n"
                      ...
                      "[test.cpp:5:5]: (warning) %d in format string (no. 2) requires 'int *' but the argument type is 'unsigned int *'. [invalidScanfArgType_int]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:6]: (warning) %d in format string (no. 2) requires 'int *' but the argument type is 'unsigned int *'.\n"
                      ...
                      "[test.cpp:6:5]: (warning) %d in format string (no. 2) requires 'int *' but the argument type is 'unsigned int *'. [invalidScanfArgType_int]\n", errout_str());
