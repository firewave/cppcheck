...
private:
    ...
    void valid_config_win32a() const {
        ...
        cppcheck::Platform platform;
        std::string errstr;
        ASSERT_EQUALS_MSG(true, platform.platform("win32a", errstr, {exename.c_str()}), errstr);
    ...
    void valid_config_unix64() const {
        ...
        cppcheck::Platform platform;
        std::string errstr;
        ASSERT_EQUALS_MSG(true, platform.platform("unix64", errstr, {exename.c_str()}), errstr);
    ...
    void valid_config_win32w() const {
        ...
        cppcheck::Platform platform;
        std::string errstr;
        ASSERT_EQUALS_MSG(true, platform.platform("win32w", errstr, { exename.c_str() }), errstr);
    ...
    void valid_config_unix32() const {
        ...
        cppcheck::Platform platform;
        std::string errstr;
        ASSERT_EQUALS_MSG(true, platform.platform("unix32", errstr, { exename.c_str() }), errstr);
    ...
    void valid_config_win64() const {
        ...
        cppcheck::Platform platform;
        std::string errstr;
        ASSERT_EQUALS_MSG(true, platform.platform("win64", errstr, { exename.c_str() }), errstr);
