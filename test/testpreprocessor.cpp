...
private:
    ...
    void if_cond10() {
        ...
        (void)PreprocessorHelper::getcode(settings0, *this, filedata, "file.c");
    }
    ...
    void ticket_3675() {
        const char* code = "#ifdef YYSTACKSIZE\n"
                           ...
                           "#if YYDEBUG\n"
                           "#endif\n";
        (void)PreprocessorHelper::getcode(settings0, *this, code, "file.c");
    ...
    void ticket_3699() {
        ...
        const std::map<std::string, std::string> actual = PreprocessorHelper::getcode(settings0, *this, code, "file.c");
