...
#define checkP(...) checkP_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void assignAndCompare() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Condition '&rHitObject' is always true\n"
                      "[test.cpp:2:9]: (style) Condition '&rHitObject' is always true [knownConditionTrueFalse]\n",
                      errout_str());
    ...
    void comparison() {
        ...
        ASSERT_EQUALS("[test.cpp:2:8] -> [test.cpp:3:8]: (style) The if condition is the same as the previous if condition [duplicateCondition]\n"
                      ...
                      "[test.cpp:2:21] -> [test.cpp:3:15]: (style) The if condition is the same as the previous if condition [duplicateCondition]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Expression '(X & 0xff00) == 0x10' is always false.\n"
                      "[test.cpp:3:12]: (style) Expression '(X & 0xff00) == 0x10' is always false. [comparisonError]\n",
                      errout_str());
    }
...
#define checkPureFunction(code) checkPureFunction_(code, __FILE__, __LINE__)
    ...
    void incorrectLogicOperator3() {
        ...
        ASSERT_EQUALS("[test.cpp:2:15]: (warning) Logical conjunction always evaluates to false: x > 5 && x == 1. [incorrectLogicOperator]\n"
                      ...
                      "[test.cpp:2:15]: (warning) Logical conjunction always evaluates to false: x > 5 && x == 1. [incorrectLogicOperator]\n", errout_str());
    }
    ...
    void incorrectLogicOperator12() { // #8696
        ...
        ASSERT_EQUALS("[test.cpp:8:9]: (style) Condition 'a>x' is always false [knownConditionTrueFalse]\n"
                      "[test.cpp:8:9]: (style) Condition 'a>x' is always false [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        check("void foo(A a) {\n"
              ...
              "}");
        ASSERT_EQUALS("[test.cpp:5:9]: (style) Condition 'a>x' is always false [knownConditionTrueFalse]\n"
                      "[test.cpp:5:9]: (style) Condition 'a>x' is always false [knownConditionTrueFalse]\n",
                      errout_str());
    }
    ...
    void secondAlwaysTrueFalseWhenFirstTrueError() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Redundant condition: The condition 'x == 4' is redundant since 'x > 3' is sufficient.\n"
                      ...
                      "[test.cpp:2:15]: (style) Redundant condition: The condition 'x == 4' is redundant since 'x > 3' is sufficient. [redundantCondition]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Redundant condition: The condition 'x > 5' is redundant since 'x != 1' is sufficient.\n"
                      ...
                      "[test.cpp:2:15]: (style) Redundant condition: The condition 'x > 5' is redundant since 'x != 1' is sufficient. [redundantCondition]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Redundant condition: The condition 'x > 5' is redundant since 'x > 6' is sufficient.\n"
                      ...
                      "[test.cpp:2:15]: (style) Redundant condition: The condition 'x > 5' is redundant since 'x > 6' is sufficient. [redundantCondition]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Redundant condition: The condition 'x > 5.5' is redundant since 'x > 6.5' is sufficient.\n"
                      ...
                      "[test.cpp:2:17]: (style) Redundant condition: The condition 'x > 5.5' is redundant since 'x > 6.5' is sufficient. [redundantCondition]\n",
                      errout_str());
    ...
    void clarifyCondition2() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Suspicious condition (bitwise operator + comparison); Clarify expression with parentheses.\n"
                      "[test.cpp:2:8]: (style) Suspicious condition (bitwise operator + comparison); Clarify expression with parentheses. [clarifyCondition]\n"
                      "[test.cpp:2:8]: (style) Suspicious condition (bitwise operator + comparison); Clarify expression with parentheses. [clarifyCondition]\n", errout_str());
    ...
    void alwaysTrue() {
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Condition 'x++==1' is always false\n"
                      "[test.cpp:3:9]: (style) Condition 'x++==1' is always false [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (style) Condition 'v<2' is always true\n"
                      "[test.cpp:4:24]: (style) Condition 'v<2' is always true [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Condition 'strlen(\"abc\")==3' is always true\n"
                      ...
                      "[test.cpp:2:22]: (style) Condition 'strlen(\"abc\")==3' is always true [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Condition 'bar(1)==0' is always false\n"
                      "[test.cpp:3:16]: (style) Condition 'bar(1)==0' is always false [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Condition 'g()==1' is always false\n"
                      "[test.cpp:3:13]: (style) Condition 'g()==1' is always false [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Condition '!s.empty()' is always false\n"
                      ...
                      "[test.cpp:3:12]: (style) Condition '!s.empty()' is always false [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:6]: (style) Return value 'static_cast<int>(1)' is always true\n"
                      "[test.cpp:6:35]: (style) Return value 'static_cast<int>(1)' is always true [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Condition 'f()' is always true\n"
                      "[test.cpp:3:16]: (style) Condition 'f()' is always true [knownConditionTrueFalse]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:5]: (style) Condition 'i==7' is always false\n"
                      "[test.cpp:5:9]: (style) Condition 'i==7' is always false [knownConditionTrueFalse]\n",
                      errout_str());
    ...
    void multiConditionAlwaysTrue() {
        ...
        ASSERT_EQUALS("[test.cpp:4]: (style) Condition 'activate' is always false\n"
                      "[test.cpp:4:7]: (style) Condition 'activate' is always false [knownConditionTrueFalse]\n", errout_str());
...
#define MSG(EXPR, RESULT)   "[test.cpp:1]: (warning) Invalid test for overflow '" EXPR "'; signed integer overflow is undefined behavior. Some mainstream compilers removes handling of overflows when optimising the code and change the code to '" RESULT "'.\n"
    ...
    void checkAssignmentInCondition() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Condition 'u=0x00000000' is always false\n"
                      "[test.cpp:2:12]: (style) Condition 'u=0x00000000' is always false [knownConditionTrueFalse]\n",
                      errout_str());
    }
    ...
    void compareOutOfTypeRange() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) Comparing expression of type 'const signed char' against value -129. Condition is always true.\n"
                      ...
                      "[test.cpp:2:15]: (style) Comparing expression of type 'const signed char' against value -129. Condition is always true. [compareValueOutOfTypeRangeError]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:3]: (style) Comparing expression of type 'const unsigned char' against value 0. Condition is always false.\n"
                      ...
                      "[test.cpp:3:14]: (style) Comparing expression of type 'const unsigned char' against value 0. Condition is always false. [compareValueOutOfTypeRangeError]\n",
                      errout_str());
    }
