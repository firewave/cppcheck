...
private:
    ...
    void ErrorMessageVerboseSymbol() const {
        ...
        ASSERT_EQUALS("(error) Programming error with sym.", msg.toString(false, templateFormat, ""));
        ASSERT_EQUALS("(error) Verbose error about sym", msg.toString(true, templateFormat, ""));
        ASSERT_EQUALS("sym\n", msg.symbolNames());
    }
    ...
    void ErrorMessageVerboseNewline() const {
        ...
        ASSERT_EQUALS("(error) Programming error.", msg.toString(false, templateFormat, ""));
