...
private:
    ...
    void ErrorMessageConstruct() const {
        ...
        const ErrorMessage msg(locs, emptyString, Severity::error, "Programming error.", "errorId", Certainty::normal);
    ...
    void ErrorMessageConstructLocations() const {
        const std::list<ErrorMessage::FileLocation> locs = { fooCpp5, barCpp8 };
        const ErrorMessage msg(locs, emptyString, Severity::error, "Programming error.", "errorId", Certainty::normal);
    ...
    void ErrorMessageVerbose() const {
        const std::list<ErrorMessage::FileLocation> locs(1, fooCpp5);
        const ErrorMessage msg(locs, emptyString, Severity::error, "Programming error.\nVerbose error", "errorId", Certainty::normal);
        ASSERT_EQUALS(1, msg.callStack.size());
        ASSERT_EQUALS("Programming error.", msg.shortMessage());
    ...
    void InconclusiveXml() const {
        ...
        const ErrorMessage msg(locs, emptyString, Severity::error, "Programming error", "errorId", Certainty::inconclusive);
    ...
    void SerializeFileLocation() const {
        ...
        const std::list<ErrorMessage::FileLocation> locs{loc1};
