...
private:
    ...
    void class14() {
        ...
        ASSERT_EQUALS("[test.cpp:9]: (warning) Possible leak in public function. The pointer 'p' is not deallocated before it is allocated.\n"
                      "[test.cpp:9:3]: (warning) Possible leak in public function. The pointer 'p' is not deallocated before it is allocated. [publicAllocationError]\n", errout_str());
    ...
    void class19() {
        ...
        ASSERT_EQUALS("[test.cpp:5]: (style) Class 'Foo' is unsafe, 'Foo::rp1' can leak by wrong usage.\n"
                      "[test.cpp:5:19]: (style) Class 'Foo' is unsafe, 'Foo::rp1' can leak by wrong usage. [unsafeClassCanLeak]\n", errout_str());
    ...
    void mismatch2() { // #5659
        ...
        ASSERT_EQUALS("[test.cpp:17]: (warning) Possible leak in public function. The pointer 'data_' is not deallocated before it is allocated.\n"
                      "[test.cpp:17:3]: (warning) Possible leak in public function. The pointer 'data_' is not deallocated before it is allocated. [publicAllocationError]\n", errout_str());
...
private:
    ...
    void assign4() {
        ...
        ASSERT_EQUALS("[test.c:7]: (error) Resource leak: s.a\n"
                      ...
                      "[test.c:7:1]: (error) Resource leak: s.a [resourceLeak]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:5]: (error) Memory leak: s.p\n"
                      "[test.cpp:5:1]: (error) Memory leak: s.p [memleak]\n",
                      errout_str());
    ...
    void localvars() {
        ...
        ASSERT_EQUALS("[test.cpp:12]: (error) Resource leak: a.f\n"
                      ...
                      "[test.cpp:12:1]: (error) Resource leak: a.f [resourceLeak]\n", errout_str());
        check(code1, false);
        ASSERT_EQUALS("[test.c:12]: (error) Resource leak: a.f\n"
                      "[test.c:12:1]: (error) Resource leak: a.f [resourceLeak]\n", errout_str());
...
private:
    ...
    void functionParameter() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (error) Allocation with calloc, memcmp doesn't release it.\n"
                      "[test.cpp:2:12]: (error) Allocation with calloc, memcmp doesn't release it. [leakNoVarFunctionCall]\n", errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:1]: (error) Allocation with new, if doesn't release it.\n"
                      "[test.cpp:1:16]: (error) Allocation with new, if doesn't release it. [leakNoVarFunctionCall]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4]: (error) Allocation with new, f doesn't release it.\n"
                      ...
                      "[test.cpp:4:7]: (error) Allocation with new, f doesn't release it. [leakNoVarFunctionCall]\n",
                      errout_str());
    ...
    void missingAssignment() {
        ...
        ASSERT_EQUALS("[test.cpp:1:29]: (error) Return value of allocation function 'new' is not stored. [leakReturnValNotUsed]\n"
                      ...
                      "[test.cpp:2:5]: (error) Return value of allocation function 'new' is not stored. [leakReturnValNotUsed]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:1]: (error) Return value of allocation function 'malloc' is not stored.\n"
                      "[test.cpp:1:27]: (error) Return value of allocation function 'malloc' is not stored. [leakReturnValNotUsed]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:1]: (error) Return value of allocation function 'new' is not stored.\n"
                      "[test.cpp:1:29]: (error) Return value of allocation function 'new' is not stored. [leakReturnValNotUsed]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:2]: (error) Allocation with new, switch doesn't release it.\n"
                      "[test.cpp:2:14]: (error) Allocation with new, switch doesn't release it. [leakNoVarFunctionCall]\n",
                      errout_str());
