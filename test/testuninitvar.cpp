...
#define checkUninitVar(...) checkUninitVar_(__FILE__, __LINE__, __VA_ARGS__)
        ...
        // Handling >> and <<
        {
...

            {
                ...
                ASSERT_EQUALS("[test.cpp:5]: (error) Uninitialized variable: c\n"
                              "[test.cpp:5:16]: (error) Uninitialized variable: c [legacyUninitvar]\n",
                              errout_str());
    ...
    void uninitvar_if() {
        ...
        ASSERT_EQUALS("[test.cpp:4:15]: (error) Uninitialized variable: c1 [legacyUninitvar]\n"
                      "[test.cpp:4:16]: (error) Uninitialized variable: c1 [legacyUninitvar]\n", errout_str());
    ...
    void uninitvar_typeof() {
        ...
        checkUninitVar("void f() {\n"
                       ...
                       "    TYPEOF(s->status);\n"
                       "}");
        TODO_ASSERT_EQUALS("", "[test.cpp:3:16]: (error) Uninitialized variable: s [legacyUninitvar]\n", errout_str());
    ...
    void uninitvar2() {
        ...
        checkUninitVar("void f() {\n"
                       ...
                       "}");
        TODO_ASSERT_EQUALS("", "[test.cpp:3:5]: (error) Uninitialized variable: abc [legacyUninitvar]\n", errout_str());
    ...
    void uninitvar9() { // 6424
        ...
        ASSERT_EQUALS("[test.cpp:2]: (error) Uninitialized variable: p\n"
                      "[test.cpp:4:5]: (error) Uninitialized variable: p [legacyUninitvar]\n", errout_str());
    }
...
#define valueFlowUninit(...) valueFlowUninit_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void uninitvar2_4494() {
        checkUninitVar("namespace N1 {\n"
                       ...
                       "}");
        ASSERT_EQUALS("[test.cpp:6:5]: (error) Uninitialized variable: p [legacyUninitvar]\n"
                      "[test.cpp:8:13]: (error) Uninitialized variable: p [legacyUninitvar]\n"
                      "[test.cpp:13]: (error) Uninitialized variable: p\n"
                      "[test.cpp:15]: (error) Uninitialized variable: p\n"
                      "[test.cpp:6:39]: (error) Uninitialized variable: p [legacyUninitvar]\n", errout_str());
    ...
    void uninitvar2_malloc() {
        ...
        ASSERT_EQUALS("[test.cpp:4]: (error) Memory is allocated but not initialized: ab\n"
                      "[test.cpp:4:13]: (error) Uninitialized struct member: ab.a [uninitStructMember]\n",
                      errout_str());
...
#define ctu(code) ctu_(__FILE__, __LINE__, code)
    void valueFlowUninitTest() {
        ...
        ASSERT_EQUALS("[test.cpp:12]: (error) Uninitialized variable: a\n"
                      ...
                      "[test.cpp:12:12]: (error) Uninitialized variable: a [uninitvar]\n",
                      errout_str());
    ...
    void valueFlowUninitStructMembers()
    {
        ...
        ASSERT_EQUALS("[test.cpp:7]: (error) Uninitialized variable: s.i\n"
                      ...
                      "[test.cpp:7:9]: (error) Uninitialized variable: s.i [uninitvar]\n",
                      errout_str());
        ...
        ASSERT_EQUALS("[test.cpp:4:9]: (error) Uninitialized variable: i [legacyUninitvar]\n"
                      ...
                      "[test.cpp:4:9]: (error) Uninitialized variable: i [uninitvar]\n",
                      errout_str());
